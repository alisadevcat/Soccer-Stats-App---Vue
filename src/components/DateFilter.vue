<template>
  <div class="mt-1 mb-3">
    <div class="float-left pr-2">Матчи</div>
    <div date-rangepicker class="flex items-center">
      <div class="relative">
        ...
        <input type="date" name="From" id="" v-model="dateFrom" @change="handleDates" class="
            bg-gray-50
      ...
      <div class="relative">
        ...
        <input type="date" name="To" id="" v-model="dateTo" @change="handleDates" class="
            bg-gray-50
            border border-gray-300
            text-gray-900
            sm:text-sm
